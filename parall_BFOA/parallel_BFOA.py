...
def main():
    ...
    numRandomBacteria = 1
    iteraciones = 3
    tumbo = 3  # Número de gaps a insertar
    nado = 3
    secuencias = list()
    ...
    dAttr = 0.01    # Reducido de 0.5
    wAttr = 0.0001 # Reducido de 0.01
    hRep = 0.2     # Reducido de 0.3
    wRep = 0.00005  # Reducido de 0.005
    ...
    for it in range(iteraciones):
        ...
        #-- NUEVO: Aplicar la búsqueda local --
        print("Aplicando búsqueda local...")
        poblacion = operadorBacterial.busquedaLocal(poblacion, numSec)
